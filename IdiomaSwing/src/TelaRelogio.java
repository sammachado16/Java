...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Lingua.png"))); // NOI18N

        lblTitulo.setText("Idioma do Programa");

        lblMensagem.setText("Clique no Botão");

        btnBotao.setText("Ver o IDIOMA");
        btnBotao.addActionListener(this::btnBotaoActionPerformed);
